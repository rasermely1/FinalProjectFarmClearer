class Tractor {
    ...
    setAdditionalShots() {
      if (globalDifficulty === "EASY") this.additionalShots = 4;
      else if (globalDifficulty === "MEDIUM") this.additionalShots = 3;
      else if (globalDifficulty === "HARD") this.additionalShots = 2;
    }
